...
export class UserController {
  ...
  @ApiOperation({ summary: 'Search user', description: 'Search user by username or fullname' })
  @Get('search')
  async searchUsers(
  ...
  @ApiOperation({ summary: 'Fetch user info', description: 'Retrieve your info by access token' })
  @Get()
  async getById(@Request() request) {
    return this.userUseCases.getUserById(request.user.id);
  }

  @ApiOperation({ summary: 'Check username', description: 'Check username is available for change' })
  ...
  @ApiOperation({ summary: 'Update user info', description: 'Update your info' })
  @Put()
  ...
  @ApiOperation({ summary: 'Update username', description: 'Update your username' })
